...
export const clinic = {
  ...
  primaryWhatsapp: {
    ...
    message:
      "Olá! Conheci a Glória Odontologia pelo site e gostaria de agendar uma avaliação.",
  },
  ...
  hero: {
    ...
    scrollLabel: "Descubra a experiência Glória",
    imageAlt:
      "Profissional em frente à identidade visual da Glória Odontologia",
  },
  ...
  gallery: [
    {
      ...
      alt: "Profissional da Glória Odontologia em frente à identidade visual da clínica",
      width: 772,
      height: 1288,
    },
    {
      src: "/brand/gallery/recepcao.webp",
      alt: "Atendimento odontológico realizado na Glória Odontologia",
      width: 1158,
      height: 828,
    },
    {
      src: "/brand/gallery/consultorio.webp",
      alt: "Profissional da Glória Odontologia durante atendimento clínico",
      width: 966,
      height: 966,
    },
...
export const units: readonly ClinicUnitConfig[] = [
  {
    ...
    whatsappMessage:
      "Olá! Conheci a Glória Odontologia pelo site e gostaria de agendar uma avaliação na unidade Matriz — Centro.",
    googleMapsUrl:
  ...
  },
  {
    ...
    whatsappMessage:
      "Olá! Conheci a Glória Odontologia pelo site e gostaria de agendar uma avaliação na unidade Filial — Parque dos Anjos.",
    googleMapsUrl:
...
export const seo = {
  title: "Glória Odontologia | Saúde bucal em Gravataí",
  description:
    "Conheça a Glória Odontologia, escolha entre as unidades Centro e Parque dos Anjos e agende seu atendimento em Gravataí.",
